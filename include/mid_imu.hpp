...
class MidIMU : public SensorI2C {
	public: 
        ...
        float scale_accel(int16_t unscaled) { return ((float) unscaled) / S_IMU_ACCEL_SENSITIVITY_FACTOR; }

        float scale_gyro(int16_t unscaled) { return ((float) unscaled) / S_IMU_GYRO_SENSITIVITY_FACTOR; }
